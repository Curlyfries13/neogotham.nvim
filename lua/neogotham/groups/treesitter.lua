...
function M.get(c, opts)
  ...
  local ret = {
    ...
    ["@constructor"]                = { fg = c.dark5 }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
    ...
    ["@keyword"]                    = { fg = c.teal, style = opts.styles.keywords }, -- For keywords that don't fall in previous categories.
    ...
    ["@punctuation.bracket"]        = { fg = c.blue1 }, -- For brackets and parens.
