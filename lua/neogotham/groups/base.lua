...
function M.get(c, opts)
  ...
  return {
    ...
    Substitute                  = { bg = c.red, fg = c.fg }, -- |:substitute| replacement text highlighting
    ...
    Whitespace                  = { fg = c.dark5 }, -- "nbsp", "space", "tab" and "trail" in 'listchars'
    ...
    Constant                    = { fg = c.blue2 }, -- (preferred) any constant
    ...
    Identifier                  = { fg = c.orange, style = opts.styles.variables }, -- (preferred) any variable name
