...
-- if you're making a NEW theme, plug all your colors into this function
-- (hint, that's what I did)
---@param opts? neogotham.Config
function M.setup(opts)
  opts = require("neogotham.config").extend(opts)

  local colors = require("neogotham.colors").setup(opts)
  local groups = require("neogotham.groups").setup(colors, opts)
  ...
  vim.g.colors_name = "neogotham-" .. opts.style
