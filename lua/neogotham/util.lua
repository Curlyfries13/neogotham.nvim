...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("neogotham.hsluv")
    if color ~= "NONE" then
...
---@param groups neogotham.Highlights
...
function M.cache.file()
  return vim.fn.stdpath("cache") .. "/neogotham.json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, neogotham.Cache
